    ...
    <div className="bg-[#1E1E2A]">
      <QueryClientProvider client={queryClient}>
        <div className="flex-col w-3/5 m-auto ">
            <h2 className="h-12  bg-slate-800 pl-4 mt-14 mb-10 text-white flex items-center text-xl font-semibold">
              Popular Movies
            </h2>
                ...
                {data?.data.results.map((movie: Movie) => (
                  ...
                  >
                    ...
                    <div className="w-[230px] absolute flex justify-between bottom-0 mx-2">
                      ...
                      <div className="text-white absolute flex rounded-full m-auto items-end  hover:text-yellow-500 right-0 bottom-3 cursor-pointer">
                        <IoPlayOutline className="" size={32} />
                      </div>
                    </div>
                  </div>
                ))}
